...
function templateChannelGate(minimized) {
  ...
  '<div id="ql-body">' +
    '<div class="ql-license-gate ql-channel-gate">' +
      ...
      '<p class="ql-gate-desc">Join our WhatsApp and YouTube channels to get updates, tips, and access information instantly.</p>' +
      '<a href="' + QL_WHATSAPP_CHANNEL + '" target="_blank" rel="noopener noreferrer" class="ql-community-btn ql-community-btn-wa">💬 Join WhatsApp Channel</a>' +
      '<button id="ql-join-channel-btn" class="ql-community-btn ql-community-btn-yt" type="button">▶ Join YouTube Channel & Unlock</button>' +
    ...
    <div id="ql-whatsapp-overlay" class="ql-overlay ql-community-overlay">
      <div class="ql-community-modal" role="dialog" aria-modal="true" aria-label="Join Saqlain's Tech World channels">
        ...
        <div class="ql-community-actions">
          <a href="${QL_WHATSAPP_CHANNEL}" target="_blank" rel="noopener noreferrer" id="ql-wa-join" class="ql-community-btn ql-community-btn-wa">💬 Join WhatsApp Channel</a>
          <a href="${QL_YOUTUBE_CHANNEL}" target="_blank" rel="noopener noreferrer" id="ql-yt-join" class="ql-community-btn ql-community-btn-yt">▶ Join YouTube Channel</a>
        </div>
        <button id="ql-wa-later" class="ql-community-later" type="button">Maybe later</button>
      </div>
    </div>
  `;
}
