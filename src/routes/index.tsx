...
function Landing() {
  ...
  const features = [
    {
      ...
      body: "Every prompt is free. No throttling, no soft caps, no fine print.",
    },
    {
      icon: Zap,
      title: "Zero latency",
      body: "Ships as a background service worker. You won't feel it running.",
    },
    {
      icon: Shield,
      title: "Private by default",
      body: "Runs locally in your browser. No prompts leave your machine.",
    },
    {
      icon: Rocket,
      title: "One-click install",
      body: "Works on Chrome, Edge, Arc and Brave in under 60 seconds.",
    },
    {
      icon: Puzzle,
      title: "Zero configuration",
      body: "Auto-detects your Lovable workspace. No API keys required.",
    },
    {
      icon: Sparkles,
      title: "Free forever updates",
      body: "Every future release lands in your extension automatically.",
    },
  ];
  ...
  const testimonials = [
    {
      name: "Amelia R.",
      role: "Indie founder",
      body: "I shipped three MVPs in a week. Unlimitly paid for itself by lunchtime on day one.",
    },
    {
      name: "Karim H.",
      role: "Design engineer",
      body: "The best $ I've spent this year — and it wasn't a subscription. Truly a lifetime deal.",
    },
    {
      name: "Priya S.",
      role: "Studio lead",
      body: "Our team stopped rationing prompts. Iteration went from careful to fearless overnight.",
    },
  ];
  ...
  const faqs = [
    {
      q: "How is this different from a paid Lovable plan?",
      a: "Unlimitly is a one-time deal negotiated on WhatsApp. No renewals, no tiers, no per-seat math. You keep the tool for life.",
    },
    {
      q: "Why isn't the price on the site?",
      a: "We tailor pricing to your team size and use case. Say hi on WhatsApp and we'll send a fair number the same afternoon.",
    },
    {
      q: "Which browsers are supported?",
      a: "Chromium browsers today: Chrome, Edge, Brave, Arc, Opera. Safari and Firefox builds are on the roadmap.",
    },
    {
      q: "Will future updates cost extra?",
      a: "Never. Every release, big or small, ships to your extension automatically. Forever means forever.",
    },
    {
      q: "Do you offer refunds?",
      a: "Yes — 14 days, no questions. If Unlimitly doesn't earn back what you paid in your first week, we don't want your money.",
    },
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-cream text-espresso">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(rgba(27,26,23,0.06) 1px, transparent 1px)",
        ...
        <div className="flex items-center justify-between rounded-full border border-espresso/10 bg-lavender/70 px-3 py-2 shadow-[0_10px_30px_-15px_rgba(27,26,23,0.15)] backdrop-blur">
          <a href="#" className="flex items-center gap-2.5 pl-2">
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-[10px] uppercase tracking-[0.2em] text-espresso/50">
                by ProFlow
              </span>
            </div>
          </a>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-12 md:grid-rows-[auto_auto_auto]">
            ...
            <div className="mt-8 flex items-center gap-6 text-xs text-espresso/60">
              <div className="flex -space-x-2">
                {[0, 1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="h-7 w-7 rounded-full border-2 border-lavender bg-gradient-to-br from-gold-light to-gold"
                  />
                ))}
              </div>
              <div>
          ...
          <Tile tone="gold" className="md:col-span-4">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-[11px] uppercase tracking-[0.2em] text-espresso/70">
                  Cost saved
                </div>
                <div className="mt-2 font-display text-3xl italic-serif">
                  vs. metered plans
                </div>
              </div>
              <Donut value={78} />
      ...
      {/* METRICS — sparkline mini cards */}
      <Section
        id="metrics"
        eyebrow="Live metrics"
        title={
          <>
            Numbers that quietly compound{" "}
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((s) => (
            <Tile key={s.label} tone="paper" className="p-6">
              <div className="text-[11px] uppercase tracking-[0.2em] text-espresso/50">
                {s.label}
              </div>
              <div className="mt-2 font-display text-4xl italic-serif">
                {s.value}
              </div>
              <div className="mt-4">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <Tile tone="paper" className="md:col-span-2">
            <div className="flex items-start justify-between">
              <div>
                <div className="text-[11px] uppercase tracking-[0.2em] text-espresso/50">
                  Prompts unlocked · last 15 days
                </div>
                <div className="mt-2 font-display text-3xl italic-serif">
                  1.24M and climbing
                </div>
              </div>
              <div className="rounded-full border border-gold/40 bg-butter px-3 py-1 text-[11px] font-medium text-gold">
                +42% mom
              </div>
            </div>
      ...
      >
        <div className="grid gap-4 md:grid-cols-12">
          {features.map((f, i) => {
            const Icon = f.icon;
            const span =
              i === 0 ? "md:col-span-6" : i === 3 ? "md:col-span-6" : "md:col-span-4";
            return (
              <Tile key={f.title} tone={i === 0 ? "gold" : "paper"} className={span}>
                <div
                  className={`grid h-12 w-12 place-items-center rounded-2xl ${
                    i === 0 ? "bg-espresso text-gold" : "bg-butter text-gold"
                  }`}
                >
                  <Icon className="h-5 w-5" />
                </div>
                <h3 className="mt-6 font-display text-2xl italic-serif">
                  {f.title}
                </h3>
      ...
      <Section
        ...
        title={
          <>
            From install to unlimited{" "}
            <span className="italic-serif text-gold">in three steps.</span>
          </>
        }
      >
        <div className="relative grid gap-4 md:grid-cols-3">
          ...
          <div
            ...
            style={{
              background:
                "repeating-linear-gradient(90deg, #C9A84C 0 6px, transparent 6px 12px)",
            }}
          />
          {steps.map((s) => (
            <Tile key={s.n} tone="paper" className="relative">
              <div className="flex items-center gap-3">
                <div className="grid h-10 w-10 place-items-center rounded-full bg-espresso text-sm font-semibold text-gold">
                  {s.n}
                </div>
                <div className="h-px flex-1 bg-espresso/10" />
                <Clock className="h-4 w-4 text-espresso/40" />
              </div>
              <h3 className="mt-6 font-display text-3xl italic-serif">
                {s.title}
              </h3>
      ...
      <Section
        ...
        title={
          <>
            Plays nicely with{" "}
            <span className="italic-serif text-gold">every stack you ship.</span>
          </>
        }
      >
          ...
          <Tile tone="paper" className="md:col-span-2">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 sm:grid-cols-4">
              {[
                ...
                <div
                  key={b}
                  className="flex items-center gap-2 rounded-xl border border-espresso/10 bg-butter/70 px-3 py-3 text-sm"
                >
      ...
      <Section
        ...
        title={
          <>
            Unlimitly vs.{" "}
            <span className="italic-serif text-gold">the meter.</span>
          </>
        }
      >
        <Tile tone="paper" className="p-0">
          <div className="grid grid-cols-3 border-b border-espresso/10 text-[11px] uppercase tracking-[0.2em] text-espresso/50">
            <div className="p-5" />
            <div className="border-l border-espresso/10 p-5 text-gold">
              Unlimitly
            </div>
            <div className="border-l border-espresso/10 p-5">
              Metered plans
            </div>
          </div>
          {compare.map((row, i) => (
            <div
              ...
              className={`grid grid-cols-3 ${
                i !== compare.length - 1 ? "border-b border-espresso/10" : ""
              }`}
            >
              <div className="p-5 text-sm font-medium text-espresso">
                {row.label}
              </div>
              ...
              <div className="border-l border-espresso/10 p-5 text-sm text-espresso/60">
                {row.b}
              </div>
            </div>
          ))}
      ...
      <Section
        ...
        title={
          <>
            Kind words from{" "}
            <span className="italic-serif text-gold">shipping people.</span>
          </>
        }
      >
        <div className="grid gap-4 md:grid-cols-3">
          {testimonials.map((t, i) => (
            <Tile key={t.name} tone={i === 1 ? "gold" : "paper"}>
              ...
              <p className="mt-4 font-display text-xl italic-serif leading-snug">
                "{t.body}"
              </p>
              <div className="mt-6 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[11px] uppercase tracking-widest text-espresso/60">
                    {t.role}
                  </div>
                </div>
              </div>
      ...
      <Section
        ...
        title={
          <>
            One conversation.{" "}
            <span className="italic-serif text-gold">One payment.</span>{" "}
            Forever yours.
          </>
        }
        lead={
      ...
      >
        <div className="mx-auto max-w-4xl">
          <div
            ...
            style={{
              background:
                "conic-gradient(from 140deg, #C9A84C, #F0D78C, #1B1A17, #C9A84C)",
            }}
          >
              ...
              <div className="relative grid gap-8 md:grid-cols-2">
                <div>
                  ...
                  <div className="mt-6 font-display text-5xl md:text-6xl">
                    Unlimitly{" "}
                    <span className="italic-serif text-gold">Pro</span>
                  </div>
                  <div className="mt-6 flex flex-wrap items-baseline gap-3">
                    <div className="font-display text-5xl italic-serif leading-none">
                      Let's talk
                    </div>
                  ...
                  <p className="mt-4 text-sm text-espresso/70">
                    Message us on WhatsApp — we'll send a fair one-time number
                    the same afternoon. Every future update, free forever.
                  </p>
                  <a
                    href={WHATSAPP_URL}
                    target="_blank"
                ...
                <div className="grid gap-3">
                  {[
                    ...
                    <div
                      key={x}
                      className="flex items-center gap-3 rounded-2xl border border-espresso/10 bg-butter/70 px-4 py-3 text-sm"
                    >
      ...
      <Section
        ...
        title={
          <>
            ...
            <span className="italic-serif text-gold">ask us first.</span>
          </>
        }
      >
          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <h3 className="mt-5 font-display text-4xl leading-[1.05] md:text-6xl">
                ...
                <span className="italic-serif text-gold">Start shipping.</span>
              </h3>
            </div>
